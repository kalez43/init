...
print_list(numbers)  # prints the list 'numbers'
...
# function that runs a for loop to print an item of a list if it matches item position of n
def print_color(color_lst):
...
print_color(colors)  # runs function on list colors
